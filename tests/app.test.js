...
describe("GET /more-than-5-stars", () => {
  afterEach(() => server.resetHandlers());

  it("returns a list with two repos", async () => {
    server.use(
  ...
  it("returns empty list when no repos have >=5 stars", async () => {
    server.use(
      http.get("https://api.github.com/orgs/stackbuilders/repos", () => {
        return HttpResponse.json([
  ...
  it("returns a full list when every repos has >=5 stars", async () => {
    server.use(
      http.get("https://api.github.com/orgs/stackbuilders/repos", () => {
        return HttpResponse.json([
          { name: "repo1", stargazers_count: 5, updated_at: "2026-01-01T00:00:00Z" },
  ...
  it("skips repos with missing attribute stargazers_count", async () => {
    server.use(
      http.get("https://api.github.com/orgs/stackbuilders/repos", () => {
        return HttpResponse.json([
...
describe("GET /last-updated", () => {
  afterEach(() => server.resetHandlers());

  it("returns a list with the 5 last updated repos", async () => {
    server.use(
      http.get("https://api.github.com/orgs/stackbuilders/repos", () => {
        return HttpResponse.json([
  ...
  it("returns a list with the 5 first repos when all of them have the same day and time", async () => {
    server.use(
      http.get("https://api.github.com/orgs/stackbuilders/repos", () => {
        return HttpResponse.json([
          { name: "repo1", stargazers_count: 6, updated_at: "2026-05-01T00:00:00Z" },
  ...
  it("returns a list with the 5 last updated repos when they have the same day but not the same time", async () => {
    server.use(
      http.get("https://api.github.com/orgs/stackbuilders/repos", () => {
        return HttpResponse.json([
...
describe("GET /sum-stars", () => {
  afterEach(() => server.resetHandlers());

  it("adds the stargazers_count attribute", async () => {
    server.use(
      http.get("https://api.github.com/orgs/stackbuilders/repos", () => {
        return HttpResponse.json([
  ...
  it("doesn't add if stargazers_count is missing", async () => {
    server.use(
      http.get("https://api.github.com/orgs/stackbuilders/repos", () => {
        return HttpResponse.json([
  ...
  it("adds the stargazers_count attribute with big numbers", async () => {
    server.use(
      http.get("https://api.github.com/orgs/stackbuilders/repos", () => {
        return HttpResponse.json([
